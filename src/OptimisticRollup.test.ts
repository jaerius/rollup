...
const ganachePrivateKeys = {
  "0x1fD45E37Aa9b1B18621A910e0e2BCdd3FCd4c3F8":
    "0xb27ce489c8268ed5b406cee761524a9e0725bd4c0cf36965aed6b0588cbbb5e0", // 여기에 실제 개인 키를 입력합니다.
  "0xCa1fB9993215DCD9e6fDB042d5985f87F22CcbA4":
    "0x62d82ef4208c572860d2e5480454a72ea3b21dc32eebd3c1dde053c30e53f3ee",
  "0xFEBBaD4c627aFAB2D717ed178d27D570FFD36C2a":
    "0x1d4f938a1ba1ab7d88fcbc44720771d998781f14edbbe0579695aee3c3edfb35",
  "0xa9b543604704c19a5fBd726D1AF95D34Ea9F0A55":
    "0xb28284568c1fdc0369000e6e7c30e9b7cf73768881e4c86a1f918dec759b1725",
};
...
async function main() {
  ...
  const privateKey =
    "0xc73b85200708cef58456b9d668ad2fcfd8491cfd1fb13e470b040b58636b2829"; // 테스트용 개인 키
  ...
  async function waitForStateBatchAppended(
    rollup: OptimisticRollup,
    batchId: string
  ) {
    return new Promise<void>((resolve, reject) => {
      rollup.l1Contract.once(
        "StateBatchAppended",
        (
          batchIndex,
          batchData,
